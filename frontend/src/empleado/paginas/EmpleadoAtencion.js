...
const EmpleadoAtencion = () => {
  ...
  const [ticketOtroDia, establecerTransferenciaTicketOtroDia] =
    useState(emptyTransfer);
  const [ticketDialogo, establecerTransferenciaTicketDialogo] = useState(false);
  const [ticketDialogoOtroDia, establecerTransferenciaTicketDialogoOtroDia] =
    useState(false);
  ...
  const transferirTicketOtroDia = () => {
    ...
    toast.current.show({
      severity: "success",
      summary: "¡Éxito!",
      detail: "Ticket transferido al siguiente día",
      life: 3000,
    });
  };
  ...
  return (
    <div className="contenedor-empleado">
      ...
      <div className="contenedor-atencion">
          ...
          <div className="detalle-acciones">
            <div className="detalle">
              <table>
                <tbody>
                  <tr>
                    <td>
                      Ticket Generado el: <span>19/07/2022 : 14:05</span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      Generación de Ticket: <span>Presencial</span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      Tipo de atención: <span>General</span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      Usuario: <span>Estudiante</span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      Transferencia: <span>No</span>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <div className="acciones">
              ...
              <Button
                className="btn"
                type="button"
                onClick={() => abrirDialogoTransferir()}
              >
                Transferir Mañana
              </Button>
              ...
              {/*MANDAR LOS IDs Para la transferencia.... supongo.*/}
              <Button className="btn" type="button">
                Cancelar
              </Button>
            </div>
        ...
        <div className="historial">
          <div className="buscar">
            ...
            <div className="campo">
              <i
                className="pi pi-angle-left paginacion"
                style={{ fontSize: "2rem", marginRight: "4px" }}
              />
              <i
                className="pi pi-angle-right paginacion"
                style={{ fontSize: "2rem", marginRight: "4px" }}
              />
              <i
      ...
      <Dialog
        visible={ticketDialogo}
        style={{ width: "450px" }}
        header="Transferencia de Ticket"
        modal
        className="p-fluid"
        footer={transferirTicketDialogoFooter}
        ...
        <div className="campo dialogo-ticket">
          <div className="agrupar">
            ...
            <Dropdown
              ...
              onChange={(e) => establecerSeleccionArea(e.value)}
          ...
          <div className="agrupar">
            ...
            <div className='horas'>
              <span className='hora llena'
              id='hora'>08:00</span>
              <span className='hora
              vacia' id='hora'>08:00</span>
              <span className='hora casilleno'
              id='hora'>08:00</span>
              ...
              <span className='hora llena' id='hora'>08:00</span>
              <span
              className="hora casilleno' id='hora'>08:00</span>
              <span className='hora llena' id='hora"
           >08:00</span>
            </div>
          </div>
        </div>
