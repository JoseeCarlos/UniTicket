...
const Dashboard = (props) => {
  ...
  const dropdownValues = [
    { name: 'Tiquipaya', code: '1' },
    { name: 'America', code: '0' },
    { name: 'Ayacucho', code: '2' },
    { name: 'Todos', code: '3' }
  ];
  ...
  const leftToolbarTemplate = () => {
    return (
      <React.Fragment>
        <div className="my-2">
          <Dropdown value={dropdownValue} onChange={(e) => setDropdownValue(e.value)} options={dropdownValues} optionLabel="name" placeholder="Seleccione el campus" />
        </div>
      </React.Fragment>
    )
  }
      ...
      <div className="grid">
        <div className="col-12 lg:col-6 xl:col-3">
          <div className="card mb-0">
            <div className="flex justify-content-between mb-3">
              <div>
                <span className="block text-500 font-medium mb-3">Tickets generados - Hoy</span>
                <div className="text-900 font-medium text-xl">152</div> {/* Cargamos la cantidad de tiquets generados hasta el momento del dia*/}
              </div>
              <div className="flex align-items-center justify-content-center bg-blue-100 border-round" style={{ width: '2.5rem', height: '2.5rem' }}>
                <i className="pi pi-ticket text-blue-500 text-xl" />
              </div>
            </div>
            <span className="text-green-500 font-medium">24 </span> {/* Cargamos la cantidad de tiquets atendidos en el dia*/}
        ...
        <div className="col-12 lg:col-6 xl:col-3">
          <div className="card mb-0">
            <div className="flex justify-content-between mb-3">
              <div>
                <span className="block text-500 font-medium mb-3">Tickets no atendidos</span>
                <div className="text-900 font-medium text-xl">28</div> {/* Cargamos la cantidad de tiquets no atendidos*/}
              </div>
              <div className="flex align-items-center justify-content-center bg-cyan-100 border-round" style={{ width: '2.5rem', height: '2.5rem' }}>
                <i className="pi pi-inbox text-cyan-500 text-xl" />
              </div>
            </div>
            <span className="text-green-500 font-medium">- 4% </span> {/* Cargamos la diferencia del porcentaje con respecto de ayer - cambiar el simbolo + por - si corresponde*/}
        ...
        <div className="col-12 lg:col-6 xl:col-3">
          <div className="card mb-0">
            <div className="flex justify-content-between mb-3">
              <div>
                <span className="block text-500 font-medium mb-3">Tickets traspasados - Hoy</span>
                <div className="text-900 font-medium text-xl">48</div> {/* Cargamos la cantidad de tiquets traspasados hoy*/}
              </div>
              <div className="flex align-items-center justify-content-center bg-orange-100 border-round" style={{ width: '2.5rem', height: '2.5rem' }}>
                <i className="pi pi-map-marker text-orange-500 text-xl" />
              </div>
            </div>
            <span className="text-green-500 font-medium"> + %52 </span> {/* Cargamos la diferencia del porcentaje con respecto de ayer - cambiar el simbolo + por - si corresponde*/}
            <span className="text-500">respecto de ayer</span>
          </div>
        </div>
        <div className="col-12 lg:col-6 xl:col-3">
          <div className="card mb-0">
            <div className="flex justify-content-between mb-3">
              <div>
                <span className="block text-500 font-medium mb-3">Quejas realizadas - Hoy </span>
